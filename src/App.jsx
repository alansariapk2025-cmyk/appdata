...
export default function App() {
        ...
        try {
          ...
          if (adminDoc.exists()) {
            ...
            setAdminCheckMessage(
              isAdminUser ? "Admin verified" : "Not an admin account"
            );
          } else {
            setIsAdmin(false);
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-red-50 to-orange-50 p-6">
        <div className="max-w-lg w-full rounded-2xl border border-red-200 bg-white p-8 text-center shadow-xl">
          ...
          <p className="text-sm text-gray-500 mb-6">
            Contact the super-admin to get admin access for your account.
          </p>
          <div className="bg-gray-50 rounded-lg p-3 mb-6">
            ...
            <p className="text-xs text-gray-500">
              <strong>Status:</strong> {adminCheckMessage}
            </p>
          </div>
          <button
  ...
  const renderScreen = () => {
    switch (activeTab) {
      ...
      case "orders":
        return <Orders onNavigate={setActiveTab} />;

      case "newOrders":
        return <NewOrders onNavigate={setActiveTab} />;
      ...
      case "adminUsers":
        return (
          <AdminUsers isSuperAdmin={isSuperAdmin} currentUser={user} />
        );
